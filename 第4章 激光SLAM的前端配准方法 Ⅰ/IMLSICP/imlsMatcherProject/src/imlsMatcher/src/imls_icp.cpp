...
Eigen::Vector2d IMLSICPMatcher::ComputeNormal(std::vector<Eigen::Vector2d> &nearPoints)
{
    ...
    {
        // std::cout << "----------" << std::endl;
        // std::cout << (v - average) * (v - average).transpose() / nearPoints.size() << std::endl;
    ...
    // std::cout << "matrix values0 = \n" << eigen_solver.eigenvalues()(0) << std::endl;
    // std::cout << "matrix values1 = \n" << eigen_solver.eigenvalues()(1) << std::endl;
    // std::cout << "matrix vectors = \n" << eigen_solver.eigenvectors() << std::endl;
    // std::cout << "matrix vectors0 = \n" << eigen_solver.eigenvectors()(0) << std::endl;
    // std::cout << "matrix vectors1 = \n" << eigen_solver.eigenvectors()(1) << std::endl;
    // std::cout << "matrix vectors2 = \n" << eigen_solver.eigenvectors()(2) << std::endl;
    // std::cout << "matrix vectors3 = \n" << eigen_solver.eigenvectors()(3) << std::endl;
    // normal(0) = eigen_solver.eigenvectors()(2).real();
    // normal(1) = eigen_solver.eigenvectors()(3).real();
